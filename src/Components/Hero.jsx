  ...
  return (
    <>
      <section className='bg-black flex flex-col-reverse md:flex-row h-[calc(100vh-4rem)] items-center justify-center' id="hero">
        ...
        <div className='flex flex-col flex-1 h-96 items-left justify-center text-center ml-10 p-24 space-y-6 md:text-left md:ml-0 md:mr-0'>
            <h1 className="text-slate-300 text-4xl font-bold uppercase tracking-wider md:text-left">Your Home's Exclusive Personal Trainer</h1>
