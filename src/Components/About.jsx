...
const About = () => {
  ...
  return (
    <section className='flex items-center justify-center h-[80vh] w-auto bg-no-repeat bg-right bg-origin-border bg-auto' style={{backgroundImage:`url(${HomePageImg})`}} id='about'>
