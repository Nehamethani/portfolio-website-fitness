...
const About = () => {
  ...
  return (
    <section className='flex items-center justify-center  p-0 lg:p-10 w-auto bg-no-repeat bg-right bg-origin-border bg-auto' style={{backgroundImage:`url(${HomePageImg})`}} id='about'>
    <div className='flex flex-col  justify-center w-full space-y-5 p-4 h-auto lg:w-4/5 lg:h-3/4 text-white text-center bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-20 p-0 lg:p-20'>
